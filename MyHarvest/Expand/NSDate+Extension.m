...
- (NSDate *)offsetMinutes:(int)numMinutes {
    return [NSDate offsetMinutes:numMinutes fromDate:self];
}
...
- (NSDate *)endTime {
    return [NSDate endTimeOfDate:self];
}

+ (NSDate *)endTimeOfDate:(NSDate *)date {
    if (date == nil) {
        return nil;
    }
